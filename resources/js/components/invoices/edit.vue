...
const getInvoice = async () => {
    let response = await axios.get(`/api/search_invoice?s=${props.id}`);
    console.log("response", response.data.invoices);
    form.value = response.data.invoices[0];
};
...
const deleteInvoiceItem = (id, i) => {
    ...
    if (id) {
        axios.get(`/api/delete_invoice_item?id=${id}`);
    }
};
            ...
            <div class="card__content">
                ...
                <div class="table">
                    ...
                    >
                        ...
                        <p v-else>
                            #{{ itemcart.item_code }} {{ itemcart.desription }}
                        </p>
                        <p>
                            <input
                                type="text"
                        ...
                        <p>RM {{ itemcart.quantity * itemcart.unit_price }}</p>
                        <p
