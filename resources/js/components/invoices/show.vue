...
import router from "../../router";
    ...
    const onEdit = (id) => {
        router.push(`/invoice/edit/${id}`).catch(() => {})
    }
            ...
            <div class="table invoice">
                ...
                <div class="table py1">
                    ...
                    <div class="table--items3" v-for="(item,i) in form.invoice_items" :key="item.id">
                        ...
                        <p>RM {{ item.unit_price }}</p>
                        <p>{{ item.quantity }}</p>
                        <p>RM {{ item.unit_price * item.quantity }}</p>
                    </div>
                </div>
                ...
                <div class="invoice__subtotal">
                    ...
                    <div>
                        <div class="invoice__subtotal--item1">
                            <p>Sub Total</p>
                            <span>RM {{ form.sub_total }}</span>
                        </div>
                        <div class="invoice__subtotal--item2">
                            <p>Discount</p>
                            <span>RM {{ form.discount }}</span>
                        </div>
                    </div>
                </div>
